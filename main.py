...
for time in range(0, 24): #generates time blocks for all activities
  shift1.append(b.block(time,time+1,10,exercise_tag))
  shift1.append(b.block(time,time+1,2,work_tag))
  shift1.append(b.block(time,time+1,10,food_tag))
